...
public class listagemVIEW extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        listaProdutos.setFocusable(false);
    ...
    private void venderProduto() throws SQLException {
        try {
            int id_produto;
            String Status_Produto = "Vendido";

            id_produto = Integer.parseInt(id_produto_venda.getText());
            /*
        String valor = cadastroValor.getText();
        String status = "A Venda";*/

            ProdutosDTO objDTO = new ProdutosDTO();
            objDTO.setStatus(Status_Produto);
            objDTO.setId(id_produto);

            ProdutosDAO objDAOproduto = new ProdutosDAO();
            objDAOproduto.venderProduto(objDTO);
        } catch (SQLException e) {
            JOptionPane.showMessageDialog(null, "erro view vender");
        }
    }
}
